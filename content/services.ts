...
export const services: Service[] = [
  ...
  // ──────────── STRUCTURATION ────────────
  {
    ...
    metaTitle: "Création de centre de santé : accompagnement complet",
  ...
  // ──────────── DÉVELOPPEMENT ────────────
  {
    ...
    metaTitle: "Développer un centre de santé : antennes, offre, financement",
  ...
  },
  {
    ...
    short: "Sourcing, contractualisation, intégration et fidélisation.",
    hero: "Accompagnement au recrutement de médecins : sourcing actif, marque employeur, ingénierie contractuelle, intégration et fidélisation.",
    icon: ICONS.user,
    pillar: "developpement",
    pillars: [
      { title: "Sourcing actif", desc: "Approche directe de médecins ciblés sur le territoire." },
      { title: "Marque employeur", desc: "Positionnement du centre et supports d’attractivité." },
      { title: "Contrats et rémunération", desc: "Statut salarié, package, clauses spécifiques au secteur." },
