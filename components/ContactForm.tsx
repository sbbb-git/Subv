  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 bg-white rounded-2xl border border-brand-100 p-6 md:p-8 shadow-sm">
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <Field label="Email" name="email" type="email" placeholder="contact@cds-exemple.fr" required />
        <Field label="Téléphone" name="phone" placeholder="06 12 34 56 78" />
      </div>
      <div>
        <label className="block text-sm font-semibold text-ink mb-1">Votre message</label>
        <textarea
          name="message"
          rows={6}
