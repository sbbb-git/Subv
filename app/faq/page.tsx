...
const faqs = [
  ...
  { q: "Comment travaillez-vous sur la subvention Teulade ?", a: "Elle est intégrée à notre audit global, jamais traitée isolément. Cela permet d’éviter les doublons avec l’ACI et le FIR, et de sécuriser l’architecture financière du CDS." },
      ...
      <section className="bg-gradient-to-br from-brand-50 to-white border-b border-brand-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <h1 className="mt-5 text-4xl md:text-5xl font-extrabold tracking-tight text-ink">
            FAQ — Cabinet de conseil pour CDS
          </h1>
